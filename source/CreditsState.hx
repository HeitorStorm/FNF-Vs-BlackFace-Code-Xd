...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop = [ //Name - Icon name - Description - Link - BG Color
			['Vs Blackface'],
			['KwPeter',		    'Abybeat',		    'Animador,Musico do mod,criador do mod',	 'https://www.tiktok.com/@kw.peter001',	            '0xFFC30085'],
			['HeitorStorm',		'Storm',		    'Coder,Progamador do Port',	                 'https://mobile.twitter.com/HeitorS03921708',	    '0xFFC30085'],			
